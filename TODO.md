...
詳細な意思決定タスクは [docs/design/phase2-migration.md](docs/design/phase2-migration.md) を参照。

- [x] Phase 2 着手タイミングの決定（→ [ADR-007](docs/adr/007-modular-monolith-migration-timing.md)）
- [ ] 境界の引き方を決める
- [ ] 技術選択（Packwerk / Engine / 名前空間）
- [ ] モジュール分割の実装
- [ ] イベント基盤の導入（分割完了後）
- [ ] 通知機能（イベント駆動で実装）
  - [ ] 注文確定通知
